...
static void SysMonInterruptHandler(void *CallBackRef)
{
	...
	logNum++;//count the number of times that the temp has been read
	...
	if (IntrStatusValue & XSM_IPIXR_EOC_MASK) {
		...
		//eject the SD card when maximum number of read is done
